...
function NinjaSlider(a) {
    ...
    var pb = function() {
            if (M) {
                ...
                fb = {
                    ...
                    a: function(a) {
                        b[c][e].left = "0px";
                        if (w && a.pointerType != "touch") return;
                    ...
                    c: function() {
                        var g = +new Date - H.t,
                            d = g < 250 && Math.abs(s.x) > 20 || Math.abs(s.x) > b[c].offsetWidth / 2;
    ...
    var Gb = function(a) {
        ...
        V = function(e) {
            for (var a = e === 1 ? c : c - 1, d = a; d < a + e; d++) zb(b[eb(d)], e);
            a == c && ub()
        },
        U = function() {
        ...
        cb = function(d, j) {
            ...
            if (j != 9)
                if (a.c == "slide" || a.m && j) {
                    ...
                    q(b[d], "ns-show");
                    (a.c == "zoom" || a.c == "kb") && b[d].nI && g.a.insertRule && S(b[d].nI, d, b[d].dL)
                }
            nb(d);
            var m = c;
            c = d;
            ...
            if (h) {
                z(h, "click", function() {
                    ...
                    for (var c, g = 0; g < b[d]; g++) {
                        c = b[g];
                        if (c.nIs)
                            if (c.nI.tagName == "IMG") c.nI.src = c.nIs[u(f, "fullscreen") ? 1 : 0];
                            else c.nI[e].backgroundImage = "url('" + c.nIs[u(f, "fullscreen") ? 1 : 0] + "')"
                    }
                });
    ...
    var K = function() {
        ...
        Bb = function(c) {
            ...
            if (k[r]) k[r]("DOMContentLoaded", b, false);
